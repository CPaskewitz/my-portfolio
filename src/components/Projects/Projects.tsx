...
const Projects: React.FC = () => {
  const projects: Project[] = [
    ...
    },
    {
      ...
      images: [
        "/Bogustore_Home_Page.webp",
        "/Bogustore_Category_Page.webp",
        "/Bogustore_Sale_Page.webp",
        "/Bogustore_Cart_Page.webp",
        "/Bogustore_Shipping_Info.webp",
        "/Bogustore_Payment_Info.webp",
        "/Bogustore_Order_Summary.webp",
        "/bogustore_productlist_test.webp",
        "/bogustore_cart_test.webp",
        "/bogustore_checkout_test.webp",
      ],
    ...
    },
    {
      ...
      images: [
        "/QuestListRPG_Home_Page.webp",
        "/QuestListRPG_Login.webp",
        "/QuestListRPG_Levelup.webp",
        "/QuestListRPG_Shop.webp",
        "/QuestListRPG_Stats.webp",
      ],
      link: "",
  ...
  const [isPreloading, setIsPreloading] = useState<boolean[]>(
    projects.map(() => false)
  );
  ...
  const handleNextImage = useCallback(
    (projectIndex: number, e?: React.MouseEvent) => {
      if (e) {
        e.stopPropagation();
      }
  ...
  const handleImageClick = useCallback(
    (image: string, alt: string, e: React.MouseEvent<Element, MouseEvent>) => {
      e.stopPropagation();
  ...
  const handleKeyboardNavigation = useCallback(
    (e: React.KeyboardEvent, projectIndex: number) => {
      if (e.key === "ArrowRight" || e.key === " ") {
        ...
        e.preventDefault();
        const currentImage =
          projects[projectIndex].images[currentImageIndex[projectIndex]];
        handleImageClick(
          currentImage,
          `${projects[projectIndex].title} screenshot ${
            ...
            >
              <div
                className={`projects__image-container ${
                  isPreloading[index] ? "is-preloading" : ""
                }`}
              >
                <LazyImage
                ...
                >
                  <svg
                    ...
                    width="24"
                    height="24"
                    className="projects__flip-icon projects__flip-icon--back"
                  >
